...
import {FbtcAdapter} from "../src/adapters/FbtcAdapter.sol";
import {MockERC20} from "./mocks/MockERC20.sol";

contract FbtcAdapterTest is Test {
    FbtcAdapter adapter;
    MockERC20 fbtc;
    ...
    function test_deploy_recordsPrincipal_onlyVault() public {
        ...
        fbtc.mint(address(adapter), 100e18);
        vm.prank(vault);
    ...
    function test_recall_returnsToken_decrementsPrincipal() public {
        ...
        assertEq(r, 40e18);
        assertEq(fbtc.balanceOf(vault), 40e18);
    ...
    function test_recall_capsAtBalance() public {
        ...
        vm.prank(vault);
        adapter.deploy(100e18);
        fbtc.mint(address(adapter), 3e18); // simulated yield
        vm.prank(vault);
